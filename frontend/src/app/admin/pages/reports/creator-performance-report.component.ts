...
@Component({
  selector: 'app-creator-performance-report',
  standalone: true,
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <p>Evaluate creator metrics and performance data</p>
      </div>
      <mat-card>
        <mat-card-content>
          <div class="empty-state">
            <mat-icon>person_outline</mat-icon>
            <p>Creator Performance</p>
          </div>
        </mat-card-content>
      </mat-card>
    </div>
...
export class CreatorPerformanceReportComponent {}
