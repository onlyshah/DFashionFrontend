...
export interface User {
  ...
  fullName: string;
  phone?: string;
  role: 'customer' | 'vendor' | 'admin' | 'super_admin' | 'end_user' | 'sales' | 'marketing' | 'support';
  department?: string;
  isActive: boolean;
  isVerified: boolean;
  avatar?: string;
...
export class UserService {
  private apiUrl = 'http://localhost:3001/api/users'; // Updated to correct port and API version
